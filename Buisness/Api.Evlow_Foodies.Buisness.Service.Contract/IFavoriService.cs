...
namespace Api.Evlow_Foodies.Buisness.Service.Contract
{
    public interface IFavoriService
    {
        ...
        /// </summary>
        /// <returns></returns>
        Task<List<FavoriDTO>> GetFavorisAsync();

        /// <summary>
        /// Cette méthode permet de récupérer un id d'une unité de mesure.
        /// </summary>
        /// <returns></returns>
        Task<FavoriDTO> GetFavoriIdAsync(int favoriId);
        ...
        Task<FavoriDTO> CreateFavoriAsync(FavoriDTO favori);
        ...
        /// </exception>
        //Task<Favori> UpdateFavoriAsync(int favoriId, FavoriDTO favori);
        ...
        Task<FavoriDTO> DeleteFavoriAsync(int favoriId);
    }
}
