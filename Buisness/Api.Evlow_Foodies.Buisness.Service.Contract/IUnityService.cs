...
namespace Api.Evlow_Foodies.Buisness.Service.Contract
{
    public interface IUnityService
    {
        ...
        /// </summary>
        /// <returns></returns>
        Task<List<UnityDTO>> GetUnityMeasuresAsync();

        /// <summary>
        /// Cette méthode permet de récupérer un id d'une unité de mesure.
        /// </summary>
        /// <returns></returns>
        Task<UnityDTO>GetUnityMeasuresIdAsync(int unityId);
        ...
        Task<UnityDTO> CreateUnityMeasureAsync(UnityDTO unity);
        ...
        /// </exception>
        Task<UnityDTO> UpdateUnityMeasureAsync(int unityId, UnityDTO unity);
        ...
        Task<UnityDTO> DeleteUnityMeasureAsync(int UnityId);
    }
}
